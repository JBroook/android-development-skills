            ...
            public void onClick(View v) {
                ...
                database
                        ...
                        .addOnSuccessListener(aVoid -> {
                            Toast.makeText(ContactsActivity.this, "Emergency contacts saved", Toast.LENGTH_SHORT).show();

                            startActivity(new Intent(ContactsActivity.this, MainActivity.class));
                        })
                        .addOnFailureListener(aVoid -> {
                            Toast.makeText(ContactsActivity.this, "Failed to save contacts", Toast.LENGTH_SHORT).show();
                        });;
            }
        });
    }
